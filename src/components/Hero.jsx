...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto">
      <div
        className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5 mb-3`}
      >
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-3 text-white-100`}>
            I design and develop robust, scalable web applications.
          </p>
        </div>
      </div>
      <ComputersCanvas />
        ...
        <a href="#about">
          <div className="w-[35] h-[64px] rounded-3xl border-4 border-secondary flex justify-center items-start p-2">
            <motion.div
              ...
              className="w-3 h-3 rounded-full bg-secondary mt-3"
            />
          </div>
        </a>
      </div>
